...
<head>
    ...
    <title>Aktivasi akun Kursus Mengemudi Indera</title>
    <!-- BEGIN: Favicon-->
            ...
            <tbody>
                <tr>
                    <td style="padding: 48px 24px 0; color: #161c2d; font-size: 18px; font-weight: 600;">
                        Halo, Peserta Kursus Indera
                    </td>
                </tr>
                <tr>
                    <td style="padding: 15px 24px 15px; color: #8492a6;">
                        Terima kasih telah membuat akun <?= site_url() ?>. Untuk melanjutkan, harap konfirmasi alamat
                ...
                <tr>
                    <td style="padding: 15px 24px;">
                        <a href="<?= site_url('activate-account') . '?token=' . $hash ?>"
                            style="padding: 8px 20px; outline: none; text-decoration: none; font-size: 16px; letter-spacing: 0.5px; transition: all 0.3s; font-weight: 600; border-radius: 6px; background-color: #2f55d4; border: 1px solid #2f55d4; color: #ffffff;">Aktivasi
                            Akun</a>
                    </td>
                </tr>
                ...
                <tr>
                    <td style="padding: 15px 24px 0; color: #2986cc;">
                        <a href="<?= site_url('activate-account') . '?token=' . $hash ?>">
                            <?= site_url('activate-account') . '?token=' . $hash ?>
                        </a>
                    </td>
                </tr>
