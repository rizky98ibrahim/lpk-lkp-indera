...
<!-- BEGIN: Judul Halaman Content (Tambah Instruktur) -->
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Tambah Instruktur</h1>
...
<!-- END Judul Halaman Content (Tambah Instruktur) -->

<!-- BEGIN: Isi Halaman Content (Tambah Instruktur) -->
<div class="content">
    <div class="block block-rounded">
        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-lg-12">
                    <form id="instruktur-form" method="post" action="<?= site_url('admin/instruktur/save'); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukan nama instruktur" autofocus
                                        value="<?= old('nik_instruktur'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukan nama instruktur" value="<?= old('nama_instruktur'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukan telepon instruktur" value="<?= old('tlp_instruktur'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email"
                                        ...
                                        aria-describedby="email_instruktur" placeholder="Masukan email instruktur"
                                        value="<?= old('email_instruktur'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        aria-describedby="status_instruktur" placeholder="(Aktif / Sakit / Tidak Aktif)"
                                        value="<?= old('status_instruktur'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Masukan alamat instruktur"><?= old('alamat_instruktur'); ?></textarea>
                            ...
                            <div class="col-md-2 my-1">
                                <img src="/backend/media/instruktur/default.png" class="img-thumbnail img-preview">
                            </div>
