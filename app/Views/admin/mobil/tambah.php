...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-grow-1 fs-3 fw-semibold my-2 my-sm-3">Tambah Mobil</h1>
...
<div class="content">
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Form Tambah Data Mobil</h3>
            <div class="block-options">
                <a href="/admin/mobil/" class="btn btn-sm btn-danger">
        ...
        <div class="block-content block-content-full">
            <div class="row">
                <div class="col-lg-12">
                    <form id="mobil-form" method="post" action="<?= site_url('admin/mobil/save'); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukan nama mobil" autofocus value="<?= old('nama_mobil'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        placeholder="Masukan tahun mobil" value="<?= old('tahun_mobil'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukan Warna mobil" value="<?= old('warna_mobil'); ?>">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        placeholder="Masukan Keterangan" value="<?= old('ket_mobil'); ?>">
