    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <a href="/mobil/tambah" class="btn btn-sm btn-primary">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">
                            <a href="/mobil/<?= $mbl['slug_mobil']; ?>"><?= $mbl['nama_mobil']; ?></a>
                        </td>
                        ...
                        <td class="text-center">
                            <a href="/mobil/detail/<?= $mbl['slug_mobil']; ?>"
                                class="btn btn-sm btn-outline-primary mx-1" title="Detail">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="/mobil/edit/<?= $mbl['slug_mobil']; ?>" class="btn btn-sm btn-outline-warning mx-1"
                                title="Edit">
                            ...
                            <form id="form-hapus" action="/admin/mobil/<?= $mbl['id_mobil']; ?>" method="post"
                                class="d-inline">
                                <?= csrf_field(); ?>
...
<script src="<?= base_url(); ?>/backend/js/pages/init-mobil.js"></script>
