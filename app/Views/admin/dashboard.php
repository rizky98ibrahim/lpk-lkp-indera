    ...
    <div class="block block-themed bg-image"
        ...
        <div class="py-5 text-center">
            ...
            <p class="font-14 text-center text-dark m-auto">
                Kerja bagus, Dashboard Anda siap digunakan! Anda dapat mengubah profile, melihat
                transaksi, menyiapkan penjadwalan, dan mengunduh laporan kursus menggunakan
                dashboard
                ini.
            </p>
        </div>
...
<script src="<?= base_url(); ?>/backend/js/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>
<script src="<?= base_url(); ?>/backend/js/plugins/chart.js/chart.min.js"></script>
<script>
